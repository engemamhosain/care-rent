...
<?php 
	...
	*/
	class Reserve{
		...
		$result_select = $this->db->select($squery);
      ...
      $query = "INSERT INTO tbl_reserve(sId,vehicleId,vehicleName,tryTrip,vehicleNumber,datePick,timePick,pickAdd,endAdd,rate,image) VALUES('$sId','$vehicleId','$vehicleName','$tryTrip','$vehicleNumber','$datePick','$timePick','$pickAdd','$endAdd','$rate','$image')";
			...
			if($inserted_row){
                ...
                public function deleteCustomerReservation($resrve_id){
			$query = "DELETE FROM tbl_reserve WHERE reserveId='$resrve_id'";
			$this->db->delete($query);
		}

		public function getReserveVehicle($sId){
                    $Id=$sId["email"];
			$query = "SELECT * FROM tbl_reserve WHERE sId = '$Id'";
